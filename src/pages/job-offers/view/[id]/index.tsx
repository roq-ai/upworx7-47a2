...
import { useJobOfferFindFirst, useRoqClient } from 'lib/roq';
...
function JobOfferViewPage() {
  ...
  const { data, error, isLoading } = useJobOfferFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('job_offer', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/job-offers/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Placed" text={data?.placed} />
